...
<table id="example" class="display" style="width:100%">
        ...
        <tbody>       
            <?php foreach ($biodata_karyawan as $mhs): ?>       
            <tr>
                <td><?php echo $mhs->id ?></td>
                <td><?php echo $mhs->nik ?></td>
                <td><?php echo $mhs->nama_karyawan ?></td>
                ...
                <td><?php echo $mhs->departemen ?></td>
                <td><?php echo $mhs->jabatan ?></td>
                <td><?php echo $mhs->no_telepon ?></td>
                <td><?php echo $mhs->status ?></td>
                <td><?php echo $mhs->alamat ?></td>
                <td><?php echo $mhs->kodepos ?></td>

                <td><a href="<?= site_url('Biodata_karyawan_c/edit_view/'.$mhs->id) ?>">
                    <i class="icon-wrench"></i> Edit |
                    <a href="<?= site_url('Biodata_karyawan_c/delete/'.$mhs->id) ?>" onclick="return confirm('Are you sure want to delete karyawan record (<?php echo $mhs->nama_karyawan; ?>) with id = <?php echo $mhs->id; ?> ?')"><i class="icon-trash"></i> Delete</a></td>
            </tr>
            <?php endforeach; ?>
...
<strong><h4><a href="<?php echo base_url('index.php/Biodata_karyawan_c/add_view/') ?>" <i class="icon-wrench"></i> Add New </h4></strong>
